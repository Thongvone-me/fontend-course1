...
import {Layout, Flex, Card, Button, Space, Menu, MenuProps, MenuItemProps, Typography, Badge, Avatar, FloatButton} from 'antd';
  ...
  return (
    <Layout className='!min-h-screen'>
        ...
        <Layout className='!bg-gray-200'>
            ...
            <Footer className='!bg-gray-200 !pt-1 !pb-3 text-center !text-gray-500'>
                @CopyRight 2025
            </Footer>
        </Layout>
