import { Button, Flex, Input, message, Modal, notification, Skeleton, Space, Table, Tooltip, Typography } from 'antd';
import { Content } from 'antd/es/layout/layout';
import { tUser } from '../../types/user.type';
import { useUsers } from '../../hook/userUser';
...
const UserView = () => {
    ...
    const handleAction = (data: tUser ,action: "edit" | "delete") => {
        ...
        const confirmDelete = async(data: tUser) => {
            Modal.confirm({
                title: <Typography.Title>Confrm delete</Typography.Title>,
                okText: "Delete",
                cancelText:"Cancel",
